        ...
        <div className="max-w-6xl px-4 mx-auto">
          <div className="text-center">
            ...
            <p className="max-w-3xl mx-auto mb-6 text-xl text-primary">
              Following Government of Kenya Guidelines for Grade 9 to Senior School Transition
            </p>
            ...
            <p className="max-w-3xl mx-auto text-lg text-gray-700">
              Guided by the Ministry of Education's Competency-Based Curriculum framework, 
              our admission process ensures fair, transparent, and merit-based placement 
              into Senior School pathways.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl px-4 mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="max-w-3xl mx-auto text-lg text-gray-700">
              The Ministry of Education has established a structured framework for Grade 9 
              graduates transitioning to Senior School (Grade 10)
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="p-6 bg-white border rounded-xl border-gray-200 shadow-sm">
              ...
              <p className="text-gray-700">
                All learners must have completed the Kenya Primary School Education 
                Assessment (KPSEA) at Grade 9 level.
              </p>
              <div className="mt-4 p-3 bg-primary/10 rounded-lg border border-primary/20">
                <p className="text-sm font-medium text-primary">Weight: 40% of placement score</p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white border rounded-xl border-gray-200 shadow-sm">
              ...
              <div className="mt-4 p-3 bg-tertiary/10 rounded-lg border border-tertiary/20">
                <p className="text-sm font-medium text-tertiary">Weight: 60% of placement score</p>
              </div>
            </div>
            ...
            <div className="p-6 bg-white border rounded-xl border-gray-200 shadow-sm">
              ...
              <p className="text-gray-700">
                Learners placed into STEM, Humanities, or Technical pathways based on 
                performance, interest, and school capacity.
              </p>
              <div className="mt-4 p-3 bg-secondary/10 rounded-lg border border-secondary/20">
                <p className="text-sm font-medium text-secondary">Guided by NEMIS Portal</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="p-8 bg-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-800">Completion of Grade 9 under CBC curriculum</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 mt-1 mr-3 text-primary">
                    <FaClipboardCheck className="w-full h-full" />
                  </div>
                  <span className="text-gray-800">Valid KPSEA results from KNEC</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 mt-1 mr-3 text-primary">
                    <FaClipboardCheck className="w-full h-full" />
                  </div>
                  <span className="text-gray-800">Registered on NEMIS (National Education Management Information System)</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 mt-1 mr-3 text-primary">
                    <FaClipboardCheck className="w-full h-full" />
                  </div>
                  <span className="text-gray-800">Age-appropriate for Grade 10 (typically 15-17 years)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-8 bg-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium text-gray-900">Original KPSEA Results Slip</span>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium text-gray-900">Birth Certificate</span>
                    <p className="text-sm text-gray-600">Or any government-issued ID</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 mt-1 mr-3 text-secondary">
                  ...
                  <div>
                    <span className="font-medium text-gray-900">Grade 9 Report Card</span>
                    <p className="text-sm text-gray-600">Complete school-based assessment records</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 mt-1 mr-3 text-secondary">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Two recent color passport-size photographs</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 text-white bg-primary">
        <div className="max-w-6xl px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            <div className="relative p-6 bg-white/10 backdrop-blur rounded-xl border border-white/20">
              <div className="absolute top-0 left-0 flex items-center justify-center w-8 h-8 -mt-4 -ml-4 text-sm font-bold text-primary rounded-full bg-white">
                1
              </div>
              <FaClipboardCheck className="mb-4 text-3xl" />
              <h3 className="mb-3 text-xl font-bold">Application</h3>
            ...
            <div className="relative p-6 bg-white/10 backdrop-blur rounded-xl border border-white/20">
              <div className="absolute top-0 left-0 flex items-center justify-center w-8 h-8 -mt-4 -ml-4 text-sm font-bold text-tertiary rounded-full bg-white">
                2
              </div>
              <FaBalanceScale className="mb-4 text-3xl" />
              <h3 className="mb-3 text-xl font-bold">Placement</h3>
              <p className="text-white/90">
            ...
            <div className="relative p-6 bg-white/10 backdrop-blur rounded-xl border border-white/20">
              <div className="absolute top-0 left-0 flex items-center justify-center w-8 h-8 -mt-4 -ml-4 text-sm font-bold text-secondary rounded-full bg-white">
                3
              </div>
              <FaSchool className="mb-4 text-3xl" />
              <h3 className="mb-3 text-xl font-bold">Selection</h3>
              <p className="text-white/90">
            ...
            <div className="relative p-6 bg-white/10 backdrop-blur rounded-xl border border-white/20">
              ...
              <h3 className="mb-3 text-xl font-bold">Reporting</h3>
              <p className="text-white/90">
          ...
          <div className="mt-12 p-6 bg-white/10 backdrop-blur rounded-xl border border-white/20">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-white/90">
                  All admissions are conducted through the official Ministry of Education placement system. 
                  Parents are advised to follow announcements on national media and the MOE website for 
        ...
        <div className="max-w-6xl px-4 mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-700">
              As per Government of Kenya regulations for public secondary schools
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="font-medium text-gray-900">Tuition Fee Waiver</p>
                  <p className="text-sm text-gray-600">Fully covered by government capitation</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="font-medium text-gray-900">Textbooks & Learning Materials</p>
                  <p className="text-sm text-gray-600">Provided through government funding</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600">Co-curricular and practical activities</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="font-medium text-gray-900">School Uniform & PE Kit</p>
                  <p className="text-sm text-gray-600">As per school specifications</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="font-medium text-gray-900">Bursaries & Scholarships</p>
                  <p className="text-sm text-gray-600">Available for needy students</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="font-medium text-gray-900">Payment Plans</p>
                  <p className="text-sm text-gray-600">Flexible arrangements available</p>
                </div>
        ...
        <div className="max-w-6xl px-4 mx-auto">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto mb-8 text-lg text-gray-700">
              Our admissions office is ready to help you navigate the GOK Senior School 
              admission process. Contact us for clarification on requirements, timelines, 
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <a href="tel:+254712345678" className="text-lg font-medium text-primary hover:underline">
                  +254 712 345 678
                </a>
              </div>
              ...
              <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <a href="mailto:admissions@kimanguday.sc.ke" className="text-lg font-medium text-secondary hover:underline">
              ...
              <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <p className="font-medium text-gray-900">Mon-Fri: 8:00 AM - 4:00 PM</p>
              </div>
            </div>
