      ...
      <div className="py-2 text-sm text-white bg-primary">
        <div className="flex flex-wrap items-center justify-between px-2 mx-auto max-w-7xl">
          <div className="flex flex-wrap">
            ...
            >
              <i className="mr-1 fas fa-phone"></i> +254 721 415 851
            </a>
            <a
          ...
          <div className="hidden mt-1 space-x-4 sm:flex">
            <a
          ...
          <div className="flex items-center justify-between py-3">
            ...
            <ul className="items-center hidden space-x-6 font-medium md:flex">
              ...
              <li className="relative group">
                ...
                <ul className="absolute left-0 z-50 hidden w-48 bg-white border border-gray-300 rounded-md shadow-md group-hover:block">
                  <li>
                    <Link
                      to="/academics"
                      className="block px-4 py-2 text-gray-800 hover:bg-primary/10"
                    >
                      Academic
                    </Link>
                  </li>
